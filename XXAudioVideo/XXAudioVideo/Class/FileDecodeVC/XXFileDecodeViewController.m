...
@interface XXFileDecodeViewController ()<AVCaptureVideoDataOutputSampleBufferDelegate,H264HwDecoderImplDelegate,XXFileDecodeViewDelegate>
{
...
@implementation XXFileDecodeViewController
